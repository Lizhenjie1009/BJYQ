  ...
  <div class="table">
    ...
    <el-table
      ...
      <template  v-for="item of theads">
        <!-- 不需要展示图片 -->
        <el-table-column
          v-if="item.prop !== 'filePath' && item.prop !== 'imagePath' && item.prop !== 'faceImage'"
          fixed
          :key="item.prop"
          :prop="item.prop"
          :label="item.label"
          ...
          <template slot-scope="scope">
            <div class="dashboard-content">
              ...
              <div
                ...
                <!-- <img v-if='scope.row.fileType === "image"' :src="scope.row.faceImage | dealPath()" alt=""> -->
                <img v-if='scope.row.fileType === "image"' :src="$src(scope.row.faceImage)" alt="">
                <!-- <video v-else :src="scope.row.faceImage | dealPath()" alt=""></video> -->
                <img class="video" v-else :src="$src(scope.row.faceImage)" alt="">
              </div>
              <div
                class="image-file"
                v-else-if="scope.row.filePath">
                <!-- <img v-if='scope.row.fileType === "image"' :src="scope.row.filePath | dealPath()" alt=""> -->
                <img v-if='scope.row.fileType === "image"' :src="$src(scope.row.filePath)" alt="">
                <!-- <video v-else :src="scope.row.filePath | dealPath()" alt=""></video> -->
                <img class="video" v-else :src="$src(scope.row.filePath)" alt="">
              </div>
              <div
                class="image-file"
                v-else-if="scope.row.imagePath">
                <!-- <img v-if='scope.row.fileType === "image"' :src="scope.row.imagePath | dealPath()" alt=""> -->
                <img v-if='scope.row.fileType === "image"' :src="$src(scope.row.imagePath)" alt="">
                <!-- <video v-else :src="scope.row.imagePath | dealPath()" alt=""></video> -->
                <img class="video" v-else :src="$src(scope.row.imagePath)" alt="">
              </div>
